      ...
      <section className="py-24 px-4 md:px-12" aria-labelledby="cta-heading">
        <div className="max-w-7xl mx-auto rounded-[64px] bg-[#0e0f0c] text-white px-8 md:px-24 py-24 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="absolute inset-0 opacity-20 pointer-events-none" aria-hidden="true">
            <div className="w-full h-full blur-[120px] animate-pulse" style={{ background: 'linear-gradient(to top right, oklch(0.6356 0.2082 25.3782), oklch(0.6758 0.1453 238.462), oklch(0.6230 0.1688 149.178))' }} />
          </div>
          <div className="relative z-10">
            ...
            <Button
              ...
              className="bg-destructive text-destructive-foreground px-14 py-6 rounded-full text-base font-extrabold hover:scale-110 transition-transform active:scale-95 shadow-2xl shadow-destructive/30 hover:bg-destructive/90"
